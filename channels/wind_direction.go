...
func getWindDirection(metarChannel, windChannel chan []string) {
...
func getWindDistribution(windChannel chan []string, distChannel chan [8]int) {
...
func main() {
	...
	go getWindDirection(metarChannel, windChannel)

	go getWindDistribution(windChannel, resultChannel)
